        ...
        if(pools != null && !pools.isEmpty()){
            for(MemoryPoolMXBean pool : pools){
                ...
                if(jvmGen!=null){
                    ...
                    ReflectionUtils.setFieldValue( ReflectionUtils.findField(jvmGen.getClass(),"committed"),jvmGen,pool.getUsage().getCommitted()/byteToMb);
                    ReflectionUtils.setFieldValue( ReflectionUtils.findField(jvmGen.getClass(),"usedRate"),jvmGen,(pool.getUsage().getUsed()*100/pool.getUsage().getCommitted()));
                }
            }
        }
